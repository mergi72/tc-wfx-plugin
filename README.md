...
[![Plugin](https://img.shields.io/badge/Plugin-v1.1.2-blue)](https://github.com/mergi72/tc-wfx-plugin/releases/tag/v1.1.2)
...
- See `CHANGELOG.md` for release history and `v1.1.2` notes.
