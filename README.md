...
[![Plugin](https://img.shields.io/badge/Plugin-v1.1.0-blue)](https://github.com/mergi72/tc-wfx-plugin/releases/tag/v1.1.0)
...
- See `CHANGELOG.md` for release history and `v1.1.0` notes.
